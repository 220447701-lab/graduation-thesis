...
\begin{table}[btph]
    ...
    \label{LOA_table}
\end{table}
本研究では, 遠隔操作ロボットを対象とする. そこで, LOAの表におけるMonitoringとGenerating, Implementingの項目に人が関与しているレベルと定義する. すると, レベル1からレベル4までが該当する. そこで, 本研究では, レベル1からレベル4までの4つの自動化レベルに分類してユースケースを検討する.